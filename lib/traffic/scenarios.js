...
TRAFFIC_SCENARIOS.push(
  {
    ...
    steps: [
      ...
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'GET', path: '/api/v1/health', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'GET-Health' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'POST', path: '/api/v1/data', host: ctx.httpHost || DEFAULT_HOST,
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'PUT', path: '/api/v1/data/1', host: ctx.httpHost || DEFAULT_HOST,
        headers: { 'Content-Type': 'application/json' },
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'DELETE', path: '/api/v1/data/1', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'DELETE-Data' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'HEAD', path: '/api/v1/health', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'HEAD-Health' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'OPTIONS', path: '/api/v1/health', host: ctx.httpHost || DEFAULT_HOST,
        headers: {
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'PATCH', path: '/api/v1/data/1', host: ctx.httpHost || DEFAULT_HOST,
        headers: { 'Content-Type': 'application/json' },
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'GET', path: '/api/v1/echo', host: ctx.httpHost || DEFAULT_HOST,
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'GET', path: '/nonexistent/path/that/does/not/exist', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'GET-404' },
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => Buffer.concat([
        buildHTTPRequest({ method: 'GET', path: '/api/v1/health', host: ctx.httpHost || DEFAULT_HOST }),
        buildHTTPRequest({ method: 'GET', path: '/api/v1/echo', host: ctx.httpHost || DEFAULT_HOST }),
...
TRAFFIC_SCENARIOS.push(
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        host: `${ctx.httpHost || DEFAULT_HOST}:${DEFAULT_HTTP_PORT}`,
        path: '/api/v1/health',
      }), label: 'HostWithPort' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
...
TRAFFIC_SCENARIOS.push(
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '/api/v1/../../etc/passwd', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'PathTraversal' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '/api/v1/%2e%2e/%2e%2e/etc/passwd', host: ctx.httpHost || DEFAULT_HOST,
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '/api/v1/%252e%252e/%252e%252e/etc/passwd', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'DoubleEncoded' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '/api/v1/' + 'a'.repeat(8192), host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'LongURI' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: "/api/v1/data?id=1' OR '1'='1", host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'SQLi-Query' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '/api/v1/health#fragment', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'FragmentURI' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '/api/v1/health\x00.html', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'NullBytePath' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '\\api\\v1\\health', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'BackslashPath' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: `http://${ctx.httpHost || DEFAULT_HOST}/api/v1/health`, host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'AbsoluteURI' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        path: '/api/v1/données/résumé', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'UnicodePath' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'OPTIONS', path: '*', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'AsteriskForm' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
...
TRAFFIC_SCENARIOS.push(
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'send', data: (ctx) => {
        ...
        return buildHTTPRequest({ path: '/api/v1/health', host: ctx.httpHost || DEFAULT_HOST, headers });
      }, label: 'ManyHeaders' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => Buffer.from(
  ...
  },
  {
    ...
    steps: [
      { type: 'connect', mode: 'plain', port: DEFAULT_HTTP_PORT },
      { type: 'send', data: (ctx) => buildHTTPRequest({
        method: 'FUZZ', path: '/api/v1/health', host: ctx.httpHost || DEFAULT_HOST,
      }), label: 'UnknownMethod' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
...
TRAFFIC_SCENARIOS.push(
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2GetRequest(1, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'GET-Request' },
      { type: 'recv', timeout: 5000, label: 'Response' },
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2GetRequest(1, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'Request' },
      { type: 'recv', timeout: 5000, label: 'Response' },
...
TRAFFIC_SCENARIOS.push(
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2GetRequest(1, '/api/v2/status', ctx.httpHost || DEFAULT_HOST), label: 'Stream1' },
      { type: 'send', data: (ctx) => buildH2GetRequest(3, '/api/v2/echo', ctx.httpHost || DEFAULT_HOST), label: 'Stream3' },
      { type: 'send', data: (ctx) => buildH2GetRequest(5, '/api/v2/data', ctx.httpHost || DEFAULT_HOST), label: 'Stream5' },
      { type: 'recv', timeout: 5000, label: 'Responses' },
      { type: 'close' },
    ],
    expected: 'PASSED',
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: () => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2Priority(1, 0, 256, false), label: 'Priority' },
      { type: 'send', data: (ctx) => buildH2GetRequest(1, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'Request' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2GetRequest(2, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'EvenStreamID' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
    expected: 'DROPPED',
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2GetRequest(0, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'Stream0Headers' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
    expected: 'DROPPED',
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2GetRequest(5, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'Stream5' },
      { type: 'send', data: (ctx) => buildH2GetRequest(3, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'Stream3-Decreasing' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
    expected: 'DROPPED',
  ...
  },
  {
    ...
    steps: (() => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        steps.push({
          type: 'send',
          data: (ctx) => buildH2GetRequest(streamId, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST),
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: () => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2WindowUpdate(0, 1048576), label: 'ConnWindowUpdate' },
      { type: 'send', data: (ctx) => buildH2GetRequest(1, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'Request' },
      { type: 'recv', timeout: 5000, label: 'Response' },
      { type: 'close' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2PostRequest(1, '/api/v2/data', ctx.httpHost || DEFAULT_HOST), label: 'POST-Headers' },
...
TRAFFIC_SCENARIOS.push(
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: () => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2Headers(1, {
        ':scheme': 'https',
        ':path': DEFAULT_HTTP2_ENDPOINT,
        ':authority': ctx.httpHost || DEFAULT_HOST,
    ...
    steps: [
      ...
      { type: 'send', data: (ctx) => {
        ...
        const headerBlock = Buffer.concat([
          ...
          hpackEncodeLiteral(':authority', ctx.httpHost || DEFAULT_HOST),
        ]);
...
TRAFFIC_SCENARIOS.push(
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2PostRequest(1, '/api/v2/data', ctx.httpHost || DEFAULT_HOST), label: 'Headers' },
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'recv', timeout: 5000, label: 'ServerSettings' },
      { type: 'send', data: (ctx) => buildH2Settings({}, true), label: 'SettingsACK' },
      { type: 'send', data: (ctx) => buildH2GetRequest(1, DEFAULT_HTTP2_ENDPOINT, ctx.httpHost || DEFAULT_HOST), label: 'GET-EndStream' },
