...
class LdapFuzzerServer {
    ...
    return new Promise((resolve, reject) => {
      ...
      const tryBind = () => {
        ...
        this._server.listen(this.port, this.hostname, () => {
          this.logger.info(`LDAP server listening on ${this.hostname}:${this.port} (TCP)`);
          resolve();
        });
      };
  ...
  async startTLS(tlsContext) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this._tlsServer.listen(this.tlsPort, this.hostname, () => {
        this.logger.info(`LDAPS server listening on ${this.hostname}:${this.tlsPort} (TLS)`);
        resolve();
      });
    });
  }
